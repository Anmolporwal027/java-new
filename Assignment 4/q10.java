...
class TestMain{
    ...
    public static void main(String args[]){
        ...
        System.out.println((BLUE_TEXT + BLACK_TEXT)+"|                   Govt. ABC SCIENCE SCHOOL ,INDORE                   |"+RESET);
...
if(percentage >= 90){
    ...
    System.out.printf((WHITE_BG + BLACK_TEXT)+"| %-20s %-47s |"+RESET+"%n", "Grade            :","E");
        ...
        for(Subject a : s){
         ...
         if(cnt >= 3){
            System.out.printf((WHITE_BG + BLACK_TEXT)+"| %-20s %-47s |"+RESET+"%n", "Result           :","Fail ");
        } else if(cnt > 0 && cnt < 3){
            System.out.printf((WHITE_BG + BLACK_TEXT)+"| %-20s %-47s |"+RESET+"%n", "Result           :","You got the Failed in " + cnt + " subjects");
        } else {
...
System.out.printf((WHITE_BG+ BLACK_TEXT)+"| %-68s |"+RESET+"%n", "Promoted to clas :   "+(ycname+1));
System.out.println((WHITE_BG+ BLACK_TEXT)+"------------------------------------------------------------------------"+RESET);
    }
}