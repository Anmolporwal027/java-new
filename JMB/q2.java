...
class Ladij{
    ...
    static String[] Aitems = {"1 soup/Welcome Drink", "1 Snack", "1 Starter", "1 Sweet Dish","1 Tea or Coffee","",""};
    static String[] Bitems = {"1 soup/Welcome Drink", "2 Snack","", "1 Starter", "1 Sweet Dish","1 Tea or Coffee",""};
    static String[] Citems = {"1 soup/Welcome Drink", "2 Snack","","1 Starter","1 Paneer Starter", "1 Sweet Dish","1 Tea or Ice Cream"};
    String soup[] = {"Tomato Soup","Veg Mancho","Hot & Sour Veg","Lemon Coriander"};
    String Snacks[] = {"Idli/Vada Sambhar","Pav Bahji","Chola kulcha","Methi Paratha","Stuffed Paratha","Muli Paratha","Noodles","Cholle Bhature","Chhola Poori","Paratah dahi","Aloo Paratha","Gobhi Paratah"};
    ...
    void show(){
        ...
        while (true) {
                 System.out.println("Enter how many perons you want in Kitty Party");
                if (sc.hasNextInt()) { 
        ...
        while (true) {
            ...
            if (sc.hasNextInt()) {
                ...
                if (choice >= 1 && choice <= 3) {
                    ...
                    System.out.println("Enter correct choice please (1, 2, or 3)!");
                }
            } else {
                System.out.println("Invalid input! Please enter numbers only.");
        ...
        //FOR SOUP OR WELCOME DRINK
            ...
            switch(Wsoup){
                case 1:
                    ...
                    LAChoosed[0] = " Roafza";
                    System.out.println("You choosed "+LAChoosed[0]);
                    break;
                case 2:
                        // show soup items
                        System.out.println((BG_MAROON + WHITE_TEXT)+"|                          Jain Mithai Bhandar                       |"+RESET);
                        ...
                        while (true) {
                            ...
                            if (sc.hasNextInt()) {
                                ...
                                if (soupchoice >= 1 && soupchoice <= 4) {
                                    break;
                                } else {
                                    System.out.println("Enter correct choice please (1-4)!");
                                }
                            } else {
                                System.out.println("Invalid input! Please enter numbers only.");
                                sc.next(); // Consume the invalid input
            ...
            System.out.println((BG_MAROON + WHITE_TEXT)+"|                          Jain Mithai Bhandar                       |"+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"|                                                                    |"+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"|                               Snacks                               |"+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"|                               ITEMS                                |"+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
            ...
            int snak;
            while (true) {
                System.out.println("Enter Your choice of Snacks (1-12)");
                if (sc.hasNextInt()) {
                    snak = sc.nextInt();
                    if (snak >= 1 && snak <= 12) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-12)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            LAChoosed[1] = Snacks[snak-1];
            System.out.println("You choosed "+LAChoosed[1]);
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Schoice = sc.nextInt();
                    if (Schoice >= 1 && Schoice <= 18) {
                        break;
                    } else {
                        System.out.println("Enter correct input (1-18)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            if(Schoice < 10){
                LAChoosed[2] = Starter1[Schoice-1];
                System.out.println("You Choosed "+LAChoosed[2]);
            }
            else if(Schoice == 18){
                LAChoosed[2] = Starter2[8];
                System.out.println("You Choosed "+LAChoosed[2]);
            }
            else{
                LAChoosed[2] = Starter2[(Schoice%9)-1];
                System.out.println("You Choosed "+LAChoosed[2]);
            }
            ...
            for(int i=0; i<Sweet.length; i++){
                ...
                while (true) {
                    ...
                    if (sc.hasNextInt()) {
                        ...
                        if (Sweetchoice >= 1 && Sweetchoice <= 4) {
                            ...
                            System.out.println("Enter correct choice (1-4)!");
                        }
                    } else {
                        System.out.println("Invalid input! Please enter numbers only.");
                        sc.next(); // Consume the invalid input
                ...
                LAChoosed[3] = Sweet[Sweetchoice-1];
                System.out.println("You Choosed "+LAChoosed[3]);

            System.out.println();
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                     1.Tea                  2. Coffee                "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            int tcchoice;
            while (true) {
                System.out.println("Enter your choice (1/2)");
            ...
            switch(tcchoice){
                case 1:
                    System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
                    System.out.println((BG_MAROON + WHITE_TEXT)+"                              Choose Tea                            "+RESET);
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
                        ...
                        if(teachoice==1){
                            LAChoosed[4] = "Black tea";
                            System.out.println("You Choosed "+LAChoosed[4]);
                        }else if(teachoice==2){
                            LAChoosed[4] = "Milk tea";
                            System.out.println("You Choosed "+LAChoosed[4]);
                        }
                        else if(teachoice==3){
                            LAChoosed[4] = "Green tea";
                            System.out.println("You Choosed "+LAChoosed[4]);
                        }
                    break;
                ...
                case 2:
                    ...
                    LAChoosed[4] = "Hot Coffee";
                    System.out.println("Available : "+LAChoosed[4]);
                    break;
            }
            ...
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                               Party A                                "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Selected Item                              "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            for(int i=0; i<LAChoosed.length; i++){
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                Aitems[i],LAChoosed[i]);
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                "","");
            }
            int finalbill;
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (finalbill == 1) {
                        ...
                        System.out.println("Enter correct choice (1)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
    ...
    void LB(){
        //FOR SOUP OR WELCOME DRINK
            ...
            switch(Wsoup){
                case 1:
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                    You Added Welcome Drink Thanks !                  "+RESET);
                    LBChoosed[0] = "Roafza";
                    System.out.println("You choosed "+LBChoosed[0]);
                    break;
                case 2:
                        // show soup items
                        System.out.println((BG_MAROON + WHITE_TEXT)+"|                          Jain Mithai Bhandar                       |"+RESET);
            ...
            LBChoosed[1] = Snacks[snak-1];
            System.out.println("You choosed "+LBChoosed[1]);

            
            int snak2;
            while (true) {
                System.out.println("Enter your choice for starter 2 (1-12)");
                if (sc.hasNextInt()) {
                    snak2 = sc.nextInt();
                    if (snak2 >= 1 && snak2 <= 12) {
                        if (snak == snak2) {
                            System.out.println("Don't enter same Starter as before!");
                        } else {
                            break;
                        }
                    } else {
            ...
            LBChoosed[2] = Snacks[snak2-1];
            System.out.println("You choosed "+LBChoosed[2]+" as your snack 2");
            ...
            if(Schoice < 10){
                LBChoosed[3] = Starter1[Schoice-1];
                System.out.println("You Choosed "+LBChoosed[3]);
            }
            else if(Schoice == 18){
                LBChoosed[3] = Starter2[8];
                System.out.println("You Choosed "+LBChoosed[3]);
            }
            else{
                LBChoosed[3] = Starter2[(Schoice%9)-1];
                System.out.println("You Choosed "+LBChoosed[3]);
            }
            ...
            for(int i=0; i<Sweet.length; i++){
                ...
                LBChoosed[4] = Sweet[Sweetchoice-1];
                System.out.println("You Choosed "+LBChoosed[4]);
            ...
            switch(tcchoice){
                case 1:
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
                        ...
                        if(teachoice==1){
                            LBChoosed[5] = "Black tea";
                            System.out.println("You Choosed "+LBChoosed[5]);
                        }else if(teachoice==2){
                            LBChoosed[5] = "Milk tea";
                            System.out.println("You Choosed "+LBChoosed[5]);
                        }
                        else if(teachoice==3){
                            LBChoosed[5] = "Green tea";
                            System.out.println("You Choosed "+LBChoosed[5]);
                        }
                    break;
                ...
                case 2:
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                         You Added Coffee Thanks !                    "+RESET);
                    LBChoosed[5] = "Hot Coffee";
                    System.out.println("Available : "+LBChoosed[4]);
                    break;
            }
            ...
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                               Party B                                "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Selected Item                              "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            for(int i=0; i<LBChoosed.length; i++){
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                Bitems[i],LBChoosed[i]);
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                "","");
            }
            int finalbill;
        ...
        PrintBill(300,"Party B");
    }
    void LC(){//FOR SOUP OR WELCOME DRINK
            System.out.println();
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                            Choose 1st Item                           "+RESET);
            ...
            switch(Wsoup){
                case 1:
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"                    You Added Welcome Drink Thanks !                  "+RESET);
                    LCChoosed[0] = "Roafza";
                    System.out.println("You choosed "+LCChoosed[0]);
                    break;
                case 2:
                        // show soup items
                        System.out.println((BG_MAROON + WHITE_TEXT)+"|                          Jain Mithai Bhandar                       |"+RESET);
            ...
            LCChoosed[1] = Snacks[snak-1];
            System.out.println("You choosed "+LCChoosed[1]);
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (snak2 >= 1 && snak2 <= 12) {
                        if (snak == snak2) {
                            System.out.println("Don't enter same Snack as before!");
                        } else {
                            break;
                        }
                    } else {
            ...
            LCChoosed[2] = Snacks[snak2-1];
            System.out.println("You choosed "+LCChoosed[2]+" as your snack 2");
            ...
            if(Schoice < 10){
                LCChoosed[3] = Starter1[Schoice-1];
                System.out.println("You Choosed "+LCChoosed[3]);
            }
            else if(Schoice == 18){
                LCChoosed[3] = Starter2[8];
                System.out.println("You Choosed "+LCChoosed[3]);
            }
            else{
                LCChoosed[3] = Starter2[(Schoice%9)-1];
                System.out.println("You Choosed "+LCChoosed[3]);
            }
            ...
            if(Pchoice < 6){
                LCChoosed[4] = PaneerDish1[Pchoice-1];
                System.out.println("You Choosed "+LCChoosed[4]);
            }
            else if(Pchoice == 10){
                LCChoosed[4] = PaneerDish2[4];
                System.out.println("You Choosed "+LCChoosed[4]);
            }
            else{
                LCChoosed[4] = PaneerDish2[(Pchoice%5)-1];
                System.out.println("You Choosed "+LCChoosed[4]);
            }
            ...
            for(int i=0; i<Sweet.length; i++){
                ...
                LCChoosed[5] = Sweet[Sweetchoice-1];
                System.out.println("You Choosed "+LCChoosed[5]);

            System.out.println();
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                     1.Tea                  2. Ice Cream              "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            int tcchoice;
            while (true) {
                System.out.println("Enter your choice (1/2)");
            ...
            switch(tcchoice){
                case 1:
                    ...
                    System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
                        ...
                        if(teachoice==1){
                            LCChoosed[6] = "Black tea";
                            System.out.println("You Choosed "+LCChoosed[6]);
                        }else if(teachoice==2){
                            LCChoosed[6] = "Milk tea";
                            System.out.println("You Choosed "+LCChoosed[6]);
                        }
                        else if(teachoice==3){
                            LCChoosed[6] = "Green tea";
                            System.out.println("You Choosed "+LCChoosed[6]);
                        }
                    break;
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        LCChoosed[6] = IceCream[Icechoice-1];
                        System.out.println("You Choosed "+LCChoosed[6]);
                        break;
            }
            ...
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                               Party C                                "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Selected Item                              "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            for(int i=0; i<LCChoosed.length; i++){
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                Citems[i],LCChoosed[i]);
                System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-33s| %-33s|"+TestMain.RESET+"%n", 
                                "","");
            }
            int finalbill;
        ...
        void PrintBill(int price,String Thali){
            ...
            double TotalPrice = 0; // Changed to double to avoid potential int overflow for gst calculation before adding to price
            double gst = 0;
            if(totalPersonA <= (totalPerson+per)){
                ...
                System.out.println((BG_MAROON + WHITE_TEXT)+"|                          Jain Mithai Bhandar                       |"+RESET);
                 ...
                 System.out.printf((BG_MAROON + WHITE_TEXT)+"| %-7s %-27s %-9s %-12s |"+RESET+"%n","Name   : ",name, "Number       : ",num);
                 System.out.println((BG_MAROON + WHITE_TEXT)+"|                                                                    |"+RESET);
                 System.out.println((BG_MAROON + WHITE_TEXT)+"|                                 PARTY                              |"+RESET);
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|--------------------------------------------------------------------|"+RESET);
                 ...
                 System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-44s|%-22s |"+TestMain.RESET+"%n", 
                              "Total target : ",totalPerson);
                 System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-44s|%-22s |"+TestMain.RESET+"%n", 
                              "Total extra came : ",totalPersonA - totalPerson);
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|--------------------------------------------------------------------|"+RESET);
                 System.out.printf((TestMain.BG_BEIGE + TestMain.BLACK_TEXT)+"|%-44s|%-22s |"+TestMain.RESET+"%n", 
                              "Price ",TotalPrice);
                 gst = TotalPrice*18/100;
...
class BreakFast{
    ...
    void showBreakfast(){
        ...
        while (true) {
                 System.out.println("Enter for how many perons you want Breakfast");
                if (sc.hasNextInt()) { 
                    totalPerson = sc.nextInt();
                    if(totalPerson > 0){
                        break;
    ...
    void choosechoice(int choice){
        switch(choice){
            ...
            // for Second category of breakfast
            case 2:
                PrintBill(230,'B');
                break;
        ...
        void PrintBill(int price,char Thali){
            int totalPersonA;
            while (true) {
                System.out.println("Enter Total no of person came in party ");
                if (sc.hasNextInt()) {
            ...
            if(totalPersonA <= (totalPerson+per)){
                TotalPrice = totalPerson*price;
                 ...
                 System.out.println((BG_MAROON + WHITE_TEXT)+"|                               BILL                                 |"+RESET);
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|--------------------------------------------------------------------|"+RESET);
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                BreakFast                           |"+RESET);
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|                                                                    |"+RESET);
                 System.out.printf((TestMain.BG_MAROON+TestMain.WHITE_TEXT)+"|%-21s| %-21s| %-21s |"+TestMain.RESET+"%n", 
                          "Name","Price" ,"Quantity");
                 System.out.println((BG_BEIGE + BLACK_TEXT)+"|--------------------------------------------------------------------|"+RESET);
...
class Thali{
        ...
        while (true) {
         ...
         while (true) {
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    thaliChoice = sc.nextInt();
                    if (thaliChoice >= 1 && thaliChoice <= 6) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-6)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            void ShowSpecificThali(int thali){
                switch(thali){
                    ...
                    default:
                        System.out.println("This should not be reached if validation works correctly.");
                        break;
                }
            }
        void ThaliA(){
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    v1choice = sc.nextInt();
                    if (v1choice >= 1 && v1choice <= 26) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-26)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    v2choice = sc.nextInt();
                    if (v2choice >= 1 && v2choice <= 26) {
                        if (v1choice == v2choice) {
                            System.out.println("Don't enter same vegetable as before!");
                        } else {
                            break;
                        }
                    } else {
            ...
            while (true) {
                System.out.println("Enter your choice (1-4)");
                if (sc.hasNextInt()) {
                    Dalchoice = sc.nextInt();
                    if (Dalchoice >= 1 && Dalchoice <= 4) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-4)!");
                    }
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Ricechoice = sc.nextInt();
                    if (Ricechoice >= 1 && Ricechoice <= 5) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-5)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (v1choice >= 1 && v1choice <= 26) {
                        ...
                        System.out.println("Enter correct input (1-26)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (Dalchoice >= 1 && Dalchoice <= 4) {
                        ...
                        System.out.println("Enter correct input (1-4)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
        ...
        void ThaliC(){
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Curdchoice = sc.nextInt();
                    if (Curdchoice >= 1 && Curdchoice <= 7) {
                        break;
                    } else {
                        System.out.println("Enter correct choice please (1-7)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
        ...
        void ThaliD(){
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (Schoice >= 1 && Schoice <= 18) {
                        ...
                        System.out.println("Enter correct choice (1-18)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Schoice2 = sc.nextInt();
                    if (Schoice2 >= 1 && Schoice2 <= 18) {
                        if (Schoice2 == Schoice) {
                            System.out.println("Don't enter same as Starter 1!");
                        } else {
                            break;
                        }
                    } else {
            ...
            if(Schoice2 < 10){
                ThaliDChoosed[2] = Starter1[Schoice2-1];
                System.out.println("Second Starter You Choosed "+ThaliDChoosed[2]);
            }
            else if(Schoice2 == 18){
                ...
                ThaliDChoosed[2] = Starter2[(Schoice2%9)-1];
                System.out.println("Second Starter You Choosed "+ThaliDChoosed[2]);
            }
            ...
            if(Pchoice < 6){
                ...
                System.out.println("You Choosed "+ThaliDChoosed[3]);
            }
            else if(Pchoice == 10){
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (Curdchoice >= 1 && Curdchoice <= 7) {
                        ...
                        System.out.println("Enter correct choice (1-7)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            // FOR SWEET OR ICE-CREAM OR COFFEE
            System.out.println();
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
        ...
        void ThaliE(){
           //FOR SOUP OR WELCOME DRINK
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Pschoice = sc.nextInt();
                    if (Pschoice >= 1 && Pschoice <= 6) {
                        break;
                    } else {
                        System.out.println("Enter correct choice (1-6)!");
                    }
                } else {
                    System.out.println("Invalid input! Please enter numbers only.");
                    sc.next(); // Consume the invalid input
            ...
            System.out.println("You choosed "+ThaliEChoosed[3]);
            ...
            while (true) {
                System.out.println("Enter your choice (1/2)");
                if (sc.hasNextInt()) {
                    Pstachoice = sc.nextInt();
                    if (Pstachoice == 1 || Pstachoice == 2) {
                        break;
                    } else {
                        System.out.println("Enter correct choice (1 or 2)!");
                    }
            ...
            System.out.println((BG_MAROON + WHITE_TEXT)+"                           Jain Mithai Bhandar                        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            System.out.println((BG_MAROON + WHITE_TEXT)+"          1.Ice Cream                                2. Coffee        "+RESET);
            System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                      "+RESET);
            int ICchoice;
            while (true) {
                System.out.println("Enter your choice (1/2)");
        ...
        void ThaliF(){
            ...
            // show soup items
                        ...
                        while (true) {
                            ...
                            if (sc.hasNextInt()) {
                                soupchoice1 = sc.nextInt();
                                if (soupchoice1 >= 1 && soupchoice1 <= 4) {
                                    break;
                                } else {
                                    System.out.println("Enter correct choice please (1-4)!");
                                }
                        ...
                        while (true) {
                            ...
                            if (sc.hasNextInt()) {
                                ...
                                if (soupchoice2 >= 1 && soupchoice2 <= 4) {
                                    if (soupchoice1 == soupchoice2) {
                                        System.out.println("Don't enter same soup as before!");
                                    } else {
                                        break;
                                    }
                                } else {
                    ...
                    while (true) {
                        ...
                        if (sc.hasNextInt()) {
                            ...
                            if (Welcomechoice == 1 || Welcomechoice == 2) {
                                break;
                            } else {
                                System.out.println("Enter correct choice (1 or 2)!");
                            }
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    Schoice3 = sc.nextInt();
                    if (Schoice3 >= 1 && Schoice3 <= 18) {
                        if (Schoice1 == Schoice3 || Schoice2 == Schoice3) {
                            System.out.println("Don't enter same Starter as Before!");
                        } else {
                            break;
                        }
            ...
            System.out.println("You Choosed "+ThaliFChoosed[6]);
            ...
            while (true) {
                System.out.println("Enter your choice (1-6)");
                if (sc.hasNextInt()) {
                    chinchoice = sc.nextInt();
                    if (chinchoice >= 1 && chinchoice <= 6) {
                        break;
                    } else {
                        System.out.println("Enter correct choice (1-6)!");
                    }
            ...
            System.out.println("You Choosed "+ThaliFChoosed[7]);
            ...
            int Sweetchoice;
            while (true) {
                System.out.println("Enter your choice for sweet 1 (1-4)");
                if (sc.hasNextInt()) {
                    Sweetchoice = sc.nextInt();
                    if (Sweetchoice >= 1 && Sweetchoice <= 4) {
                        break;
            ...
            while (true) {
                ...
                if (sc.hasNextInt()) {
                    ...
                    if (Sweetchoice2 >= 1 && Sweetchoice2 <= 4) {
                        if (Sweetchoice == Sweetchoice2) {
                            System.out.println("Don't enter same sweet as sweet 1!");
                        } else {
                            break;
                        }
                    } else {
            ...
            ThaliFChoosed[15] = Sweet[Sweetchoice2-1];
...
class TestMain{
    ...
    public static void main(String args[]){
        ...
        System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                        "+RESET);
        System.out.println((BG_MAROON + WHITE_TEXT)+"         1. BreakFast           2. Lunch            3. Ladies Party     "+RESET);
        System.out.println((BG_BEIGE + BLACK_TEXT)+"                                                                        "+RESET);       
        int choice;
        while (true) {
